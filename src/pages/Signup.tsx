        ...
        <div className="bg-slate-800/50 backdrop-blur-md border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="space-y-3">
              <Button
                ...
                className="w-full bg-white hover:bg-gray-100 text-gray-800 font-medium py-3 rounded-lg transition-colors flex items-center justify-center gap-3"
              >
              ...
              <Button
                ...
                className="w-full bg-[#1877F2] hover:bg-[#166FE5] text-white font-medium py-3 rounded-lg transition-colors flex items-center justify-center gap-3"
              >
