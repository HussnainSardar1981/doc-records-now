...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-12 md:top-16 right-0 z-[100] flex max-h-screen w-full flex-col p-2 sm:p-4 sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
